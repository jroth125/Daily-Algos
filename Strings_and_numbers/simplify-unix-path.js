/*
Given an absolute path for a file (Unix-style), simplify it. Or in other words, convert 
...
be only a single slash / between two directory names. The last directory name (if it exists) 
